...
namespace System.Numerics.Tests
{
    ...
    public class Worker
    {
        ...
        {
            Assert.AreEqual(a.Sign, (int)expected);
        }
        ...
        {
            Assert.AreEqual(MyBigIntImp.ApproximateBigInteger(BigInteger.Log10(a)), expected);
        }

        private void Log(BigInteger a, BigInteger expected)
        {
            Assert.AreEqual(MyBigIntImp.ApproximateBigInteger(BigInteger.Log(a)), expected);
        }

        private void Abs(BigInteger a, BigInteger expected)
        {
            Assert.AreEqual(BigInteger.Abs(a), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Negate(a), expected);
        }
        ...
        {
            Assert.AreEqual(MyBigIntImp.ApproximateBigInteger(BigInteger.Log(a, (double)b)), expected);
        }

        private void GCD(BigInteger a, BigInteger b, BigInteger expected)
        {
            Assert.AreEqual(BigInteger.GreatestCommonDivisor(a, b), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Remainder(a, b), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Divide(a, b), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Multiply(a, b), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Subtract(a, b), expected);
        }
        ...
        {
            Assert.AreEqual(BigInteger.Add(a, b), expected);
        }
