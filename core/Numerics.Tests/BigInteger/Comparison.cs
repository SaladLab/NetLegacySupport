...
namespace System.Numerics.Tests
{
    public class ComparisonTest
    {
        ...
        {
            // BigInteger.Zero, 0
            Assert.AreEqual(false, BigInteger.Zero.Equals((Object)0));

            // BigInteger.Zero, null
            Assert.AreEqual(false, BigInteger.Zero.Equals((Object)null));
        ...
        //    Assert.AreEqual(1, comparable.CompareTo(null));
        ...
        private static void VerifyComparison(BigInteger x, BigInteger y, int expectedResult)
        {
            ...
            Assert.AreEqual(expectedEquals, x == y);
            Assert.AreEqual(expectedEquals, y == x);

            Assert.AreEqual(!expectedEquals, x != y);
            Assert.AreEqual(!expectedEquals, y != x);

            Assert.AreEqual(expectedEquals, x.Equals(y));
            Assert.AreEqual(expectedEquals, y.Equals(x));

            Assert.AreEqual(expectedEquals, x.Equals((Object)y));
            Assert.AreEqual(expectedEquals, y.Equals((Object)x));
            ...
            Assert.AreEqual(expectedLessThan, x < y);
            Assert.AreEqual(expectedGreaterThan, y < x);

            Assert.AreEqual(expectedGreaterThan, x > y);
            Assert.AreEqual(expectedLessThan, y > x);

            Assert.AreEqual(expectedLessThan || expectedEquals, x <= y);
            Assert.AreEqual(expectedGreaterThan || expectedEquals, y <= x);

            Assert.AreEqual(expectedGreaterThan || expectedEquals, x >= y);
            Assert.AreEqual(expectedLessThan || expectedEquals, y >= x);
        }
        ...
        private static void VerifyComparison(BigInteger x, Int32 y, int expectedResult)
        {
            ...
            if (expectedEquals)
            {
                Assert.AreEqual(x.GetHashCode(), ((BigInteger)y).GetHashCode());
                Assert.AreEqual(x.ToString(), ((BigInteger)y).ToString());
            }
            
            Assert.AreEqual(x.GetHashCode(), x.GetHashCode());
            Assert.AreEqual(((BigInteger)y).GetHashCode(), ((BigInteger)y).GetHashCode());
        ...
        private static void VerifyComparison(BigInteger x, UInt64 y, int expectedResult)
        {
            ...
            {
                Assert.AreNotEqual(x.GetHashCode(), ((BigInteger)y).GetHashCode());
                Assert.AreNotEqual(x.ToString(), ((BigInteger)y).ToString());
            }
        ...
        private static void VerifyCompareResult(int expected, int actual, string message)
        {
            ...
            {
                Assert.IsTrue(int.MinValue <= actual && actual <= -1);
            }
            else if (0 < expected)
            {
                Assert.IsTrue(1 <= actual && actual <= int.MaxValue);
            }
        }
