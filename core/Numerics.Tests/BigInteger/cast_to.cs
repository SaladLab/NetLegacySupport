...
namespace System.Numerics.Tests
{
    public class cast_toTest
    {
        ...
        private static void VerifyByteImplicitCastToBigInteger(Byte value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (Byte)bigInteger);

            if (value != Byte.MaxValue)
            {
                Assert.AreEqual((Byte)(value + 1), (Byte)(bigInteger + 1));
            }
        ...
        private static void VerifySByteImplicitCastToBigInteger(SByte value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (SByte)bigInteger);

            if (value != SByte.MaxValue)
            {
                Assert.AreEqual((SByte)(value + 1), (SByte)(bigInteger + 1));
            }
        ...
        private static void VerifyUInt16ImplicitCastToBigInteger(UInt16 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (UInt16)bigInteger);

            if (value != UInt16.MaxValue)
            {
                Assert.AreEqual((UInt16)(value + 1), (UInt16)(bigInteger + 1));
            }
        ...
        private static void VerifyInt16ImplicitCastToBigInteger(Int16 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (Int16)bigInteger);

            if (value != Int16.MaxValue)
            {
                Assert.AreEqual((Int16)(value + 1), (Int16)(bigInteger + 1));
            }
        ...
        private static void VerifyUInt32ImplicitCastToBigInteger(UInt32 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (UInt32)bigInteger);

            if (value != UInt32.MaxValue)
            {
                Assert.AreEqual((UInt32)(value + 1), (UInt32)(bigInteger + 1));
            }
        ...
        private static void VerifyInt32ImplicitCastToBigInteger(Int32 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (Int32)bigInteger);

            if (value != Int32.MaxValue)
            {
                Assert.AreEqual((Int32)(value + 1), (Int32)(bigInteger + 1));
            }
        ...
        private static void VerifyUInt64ImplicitCastToBigInteger(UInt64 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (UInt64)bigInteger);

            if (value != UInt64.MaxValue)
            {
                Assert.AreEqual((UInt64)(value + 1), (UInt64)(bigInteger + 1));
            }
        ...
        private static void VerifyInt64ImplicitCastToBigInteger(Int64 value)
        {
            ...
            //Assert.AreEqual(value, bigInteger);
            Assert.AreEqual(value.ToString(), bigInteger.ToString());
            Assert.AreEqual(value, (Int64)bigInteger);

            if (value != Int64.MaxValue)
            {
                Assert.AreEqual((Int64)(value + 1), (Int64)(bigInteger + 1));
            }
        ...
        private static void VerifySingleExplicitCastToBigInteger(Single value)
        {
            ...
            Assert.AreEqual(expectedValue, (Single)bigInteger);
            ...
            {
                Assert.AreEqual(expectedValue.ToString("G9"), bigInteger.ToString());
            }

            if (expectedValue != Math.Floor(Single.MaxValue))
            {
                Assert.AreEqual((Single)(expectedValue + 1), (Single)(bigInteger + 1));
            }
        ...
        private static void VerifyDoubleExplicitCastToBigInteger(Double value)
        {
            ...
            Assert.AreEqual(expectedValue, (Double)bigInteger);
            ...
            {
                Assert.AreEqual(expectedValue.ToString(), bigInteger.ToString());
            }

            if (!Single.IsInfinity((Single)expectedValue))
            {
                Assert.AreEqual((Double)(expectedValue + 1), (Double)(bigInteger + 1));
                Assert.AreEqual((Double)(expectedValue - 1), (Double)(bigInteger - 1));
            }
        ...
        private static void VerifyDecimalExplicitCastToBigInteger(Decimal value)
        {
            ...
            Assert.AreEqual(expectedValue.ToString(), bigInteger.ToString());
            Assert.AreEqual(expectedValue, (Decimal)bigInteger);

            VerifyBigIntegerUsingIdentities(bigInteger, 0 == expectedValue);

            if (expectedValue != Math.Floor(Decimal.MaxValue))
            {
                Assert.AreEqual((Decimal)(expectedValue + 1), (Decimal)(bigInteger + 1));
            }
        ...
        private static void VerifyBigIntegerUsingIdentities(BigInteger bigInteger, bool isZero)
        {
            ...
            Assert.AreEqual(bigInteger, tempBigInteger);
            ...
            {
               Assert.AreNotEqual(BigInteger.Zero, bigInteger);

                // x/x = 1
               Assert.AreEqual(BigInteger.One, bigInteger / bigInteger);
            }

            // (x + 1) - 1 = x
            Assert.AreEqual(bigInteger, (bigInteger + BigInteger.One) - BigInteger.One);

            // (x + 1) - x = 1
            Assert.AreEqual(BigInteger.One, (bigInteger + BigInteger.One) - bigInteger);

            // x - x = 0
            Assert.AreEqual(BigInteger.Zero, bigInteger - bigInteger);

            // x + x = 2x
            Assert.AreEqual(2 * bigInteger, bigInteger + bigInteger);
