...
namespace System.Numerics.Tests
{
    public class BigIntegerConstructorTest
    {
        ...
        private static void VerifyCtorInt32(Int32 value)
        {
            ...
            Assert.AreEqual(0, String.CompareOrdinal(value.ToString(), bigInteger.ToString()));
        ...
        private static void VerifyCtorByteArray(byte[] value, UInt64 expectedValue)
        {
            ...
            //Assert.AreEqual(expectedValue, bigInteger);
            ...
            Assert.AreEqual(expectedValue, (UInt64)bigInteger);

            if (expectedValue != UInt64.MaxValue)
            {
                Assert.AreEqual((UInt64)(expectedValue + 1), (UInt64)(bigInteger + 1));
            }
        ...
        private static void VerifyCtorByteArray(byte[] value)
        {
            ...
            if (IsOutOfRangeInt64(value))
            {
                ...
                Assert.AreEqual(BitConverter.ToInt64(tempByteArray, 0), (Int64)tempBigInteger);
            }
            else
            {
                Assert.AreEqual(BitConverter.ToInt64(value, 0), (Int64)bigInteger);
            }
            ...
            if (IsOutOfRangeUInt64(value))
            {
                ...
                Assert.AreEqual(BitConverter.ToUInt64(tempByteArray, 0), (UInt64)tempBigInteger);
            }
            else
            {
                Assert.AreEqual(BitConverter.ToUInt64(value, 0), (UInt64)bigInteger);
            }
