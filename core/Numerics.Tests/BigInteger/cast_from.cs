...
namespace System.Numerics.Tests
{
    public class cast_fromTest
    {
        ...
        {
            Assert.AreEqual((Single)Math.Truncate(value), (Single)bigInteger);
        }
        ...
        {
            Assert.AreEqual(Math.Truncate(value), (Double)bigInteger);
        }
        ...
        {
            Assert.AreEqual(value, (Decimal)bigInteger);
        }
