...
namespace System.Numerics.Tests
{
    public class logTest
    {
        ...
        [Test]
#if NET20
        public static void RunLogTests_NET20()
#elif NET35
        public static void RunLogTests_NET35()
#elif NET40
        public static void RunLogTests_NET40()
#endif
        {
            ...
            Assert.AreEqual(0, BigInteger.Log(1, Double.PositiveInfinity));
            ...
            for (int i = 0; i < s_samples; i++)
            {
                Assert.AreEqual(Double.PositiveInfinity, BigInteger.Log(0, s_random.NextDouble()));
            }
